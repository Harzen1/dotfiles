...
globalkeys = gears.table.join(
    ...
    awful.key({ "Shift", },"XF86AudioRaiseVolume",function () awful.util.spawn("playerctl volume 0.05+")end,
              {description = "Raise Current Player Volume",group = "awesome"}),
    awful.key({ },"XF86AudioLowerVolume",function()awful.util.spawn("pamixer -d 3")end,
              {description = "Decrease Volume",group = "awesome"}),
    awful.key({ "Shift", },"XF86AudioLowerVolume",function () awful.util.spawn("playerctl volume 0.05-")end,
              {description = "Decrease Current Player Volume",group = "awesome"}),
